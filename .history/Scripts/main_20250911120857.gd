...
func generate_all_trials(case_ = null):
	...
	match case_:
		...
		1: # unfinished
			...
			blk_("full", "norm_1st", 1, 20,40) 
			blk_("random_distribution", "norm_after_1st", 2, 20,40)
			blk_("random_distribution", "norm_after_1st", 3, 20,40)
			blk_("random", "norm_after_1st", 4, 20,40)
			blk_("random", "norm_after_1st", 5, 20,40)
			blk_("random", "norm_after_1st", 6, 20,40)
			blk_("random", "norm_after_1st", 7, 20,40)
			blk_("random", "norm_after_1st", 8, 20,40)
			blk_("random", "norm_after_1st", 9, 20,40)
			blk_("random", "norm_after_1st", 10, 20,40)
			blk_("random", "norm_after_1st", 11, 20,40)
			blk_("random", "norm_after_1st", 12, 20,40)
			blk_("random", "norm_after_1st", 13, 20,40)
			blk_("random", "norm_after_1st", 14, 20,40)
			blk_("random", "norm_after_1st", 15, 20,40)
			blk_("random", "norm_after_1st", 16, 20,40)
			blk_("random", "norm_after_1st", 17, 20,40)
			blk_("random", "norm_after_1st", 18, 20,40)
			blk_("random", "norm_after_1st", 19, 20,40)
			blk_("random", "norm_after_1st", 20, 20,40)
