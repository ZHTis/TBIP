...
func generate_all_trials(case_ = null):
	...
	match case_:
		...
		1: # unfinished
			...
			blk_("full", "norm_1st", 1, 511) 
			blk_("random_distribution", "norm_after_1st", 2, 5,10)
			blk_("random_distribution", "norm_after_1st", 3,5,10)
			blk_("random", "norm_after_1st", 4, 5,10)
			blk_("random", "norm_after_1st", 5, 5,10)
			blk_("random", "norm_after_1st", 6, 5,10)
			blk_("random", "norm_after_1st", 7, 5,10)
			blk_("random", "norm_after_1st", 8, 5,10)
			blk_("random", "norm_after_1st", 9, 5,10)
			blk_("random", "norm_after_1st", 10, 5,10)
			blk_("random", "norm_after_1st", 11, 5,10)
			blk_("random", "norm_after_1st", 12, 5,10)
			blk_("random", "norm_after_1st", 13, 5,10)
			blk_("random", "norm_after_1st", 14, 5,10)
			blk_("random", "norm_after_1st", 15, 5,10)
			blk_("random", "norm_after_1st", 16, 5,10)
			blk_("random", "norm_after_1st", 17, 5,10)
			blk_("random", "norm_after_1st", 18, 5,10)
			blk_("random", "norm_after_1st", 19, 5,10)
			blk_("random", "norm_after_1st", 20, 5,10)
